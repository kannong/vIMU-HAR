...
class DecideTree:
    def __init__(self, max_depth, min_samples_split, min_samples_leaf, max_features, max_leaf_nodes, normalize=True):
        ...
        self.tree_clf = DecisionTreeClassifier(max_depth=max_depth,
    ...
    def model_train(self):
        ...
        # 模型预测与评估
        y_train_pred = self.tree_clf.predict(self.X_test)
        score = self.tree_clf.score(self.X_test, self.Y_test)
    ...
    def model_predit(self, x_test):
        ...
        # 预测类别
        y_predit_val = self.tree_clf.predict(x_test)
