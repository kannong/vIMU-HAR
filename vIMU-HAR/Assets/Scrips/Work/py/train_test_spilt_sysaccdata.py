...
输出：
    ...
    test_num ：测试集数目
'''
# train_data_path = 'E:/unity_pro/0_My_work/Assets/StreamingAssets/SourcesFolder/Data_Process/train_data.csv'
# test_data_path = 'E:/unity_pro/0_My_work/Assets/StreamingAssets/SourcesFolder/Data_Process/test_data.csv'
floder = "E:/unity_pro/My_workV0.0/Assets/StreamingAssets/SourcesFolder/IMUSim_temp/my_imu_datas/imureal/train_test_data/fine-tune7/3/"
...
class Train_Test_Spilt_Rawdata():
    def __init__(self, filepath, train_size, object_name, window_size, window_step):
        ...
        self.train_data_path = floder + self.object_name + '_sysacc_train_data.csv'
        self.test_data_path = floder + self.object_name + '_sysacc_test_data.csv'
...
# 单独运行Python时用
path = 'E:/unity_pro/My_workV0.0/Assets/StreamingAssets/SourcesFolder/IMUSim_temp/my_imu_datas/imureal/raw_data/fine-tune7/all_data3.csv'
spilt_test(filepath=path, train_spilt=4.0, test_spilt=1.0,
           object_name='all_data3', window_size=40, window_step=20)
# path = 'E:/unity_pro/My_workV0.0/Assets/StreamingAssets/SourcesFolder/IMUReal/object_data/Knee_Kick_r_upleg_JNT_sysaccdata.csv'
# spilt_test(filepath=path, train_spilt=3.0, test_spilt=1.0,
#            object_name='Knee_Kick_r_upleg_JNT', window_size=40, window_step=20)
